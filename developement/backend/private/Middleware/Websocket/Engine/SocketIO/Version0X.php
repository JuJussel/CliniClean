...
namespace App\Middleware\Websocket\Engine\SocketIO;
...
use App\Middleware\Websocket\EngineInterface;
use App\Middleware\Websocket\Payload\Encoder;
use App\Middleware\Websocket\Engine\AbstractSocketIO;

use App\Middleware\Websocket\Exception\SocketException;
use App\Middleware\Websocket\Exception\UnsupportedTransportException;
use App\Middleware\Websocket\Exception\ServerConnectionFailureException;
