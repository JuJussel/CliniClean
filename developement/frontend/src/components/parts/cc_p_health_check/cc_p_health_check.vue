        ...
        <div v-if="input">
            <div class="switch-cont">
                <cui-switch
                    ...
                    v-model="input.medicationHistory.value"
            ...
            <div class="switch-cont">
                <cui-switch
                    :label="$lang.medicalHistory"
                    v-model="input.medicalHistory.value"
                    :disabled="!$aclService(2)"
                />
                <cui-textarea
            ...
            <div class="switch-cont">
                <cui-switch
                    :label="$lang.subjectiveSymtoms"
                    v-model="input.subjectiveSymtoms.value"
                    :disabled="!$aclService(2)"
                />
                <cui-textarea
            ...
            <div class="switch-cont">
                <cui-switch
                    :label="$lang.objectiveSymtoms"
                    v-model="input.objectiveSymtoms.value"
                    :disabled="!$aclService(2)"
                />
                <cui-textarea
            ...
            <div style="display: flex">
                <cui-input
                    @update:modelValue="calcBMI"
                    :label="$lang.height"
                    v-model="input.height.value"
                    type="number"
                    style="max-width: 150px"
                    :append="input.height.unit"
                    :disabled="!$aclService(2)"
                />
                <cui-input
                    @update:modelValue="calcBMI"
                    :label="$lang.weight"
                    v-model="input.weight.value"
                    type="number"
                    style="max-width: 150px; margin-left: 20px"
                    :append="input.weight.unit"
                    :disabled="!$aclService(2)"
                />
            </div>
            <div style="display: flex">
                <cui-input
                    :label="$lang.bmi"
                    v-model="input.bmi.value"
                    type="number"
                    style="max-width: 150px"
                    :disabled="!$aclService(2)"
                />
                <cui-input
                    :label="$lang.stomacheWidth"
                    v-model="input.stomacheWidth.value"
                    type="number"
                    style="max-width: 150px; margin-left: 20px"
                    :append="input.stomacheWidth.unit"
                    :disabled="!$aclService(2)"
                />
            </div>
            <div style="display: flex">
                <cui-input
                    :label="$lang.bloodPreasureMin"
                    v-model="input.bloodPreasureMin.value"
                    type="number"
                    style="max-width: 150px"
                    :append="input.bloodPreasureMin.unit"
                    :disabled="!$aclService(2)"
                />
                <cui-input
                    :label="$lang.bloodPreasureMax"
                    v-model="input.bloodPreasureMax.value"
                    type="number"
                    style="max-width: 150px; margin-left: 20px"
                    :append="input.bloodPreasureMax.unit"
                    :disabled="!$aclService(2)"
                />
            </div>
            <div style="display: flex">
                <cui-input
                    :label="$lang.sightLeft"
                    v-model="input.sightLeft.value"
                    type="number"
                    style="max-width: 150px"
                    :disabled="!$aclService(2)"
                />
                <cui-input
                    :label="$lang.sightRight"
                    v-model="input.sightRight.value"
                    type="number"
                    style="max-width: 150px; margin-left: 20px"
                    :disabled="!$aclService(2)"
                />
            ...
            <div style="display: flex">
                <cui-input
                    :label="$lang.hearingLeftLow"
                    v-model="input.hearingLeftLow.value"
                    type="number"
                    style="max-width: 150px"
                    :disabled="!$aclService(2)"
                />
                <cui-input
                    :label="$lang.hearingLeftHight"
                    v-model="input.hearingLeftHight.value"
                    type="number"
                    style="max-width: 150px; margin-left: 20px"
                    :disabled="!$aclService(2)"
                />
            ...
            <div style="display: flex">
                <cui-input
                    :label="$lang.hearingRightLow"
                    v-model="input.hearingRightLow.value"
                    type="number"
                    style="max-width: 150px"
                    :disabled="!$aclService(2)"
                />
                <cui-input
                    :label="$lang.hearingRightHigh"
                    v-model="input.hearingRightHigh.value"
                    type="number"
                    style="max-width: 150px; margin-left: 20px"
                    :disabled="!$aclService(2)"
                />
        ...
        <div>
            <div style="display: flex; align-items: baseline">
                ...
                <cui-radio
                    ...
                    :disabled="!$aclService(2)"
                />
                <span style="width: 70px; margin-left: 40px">
                    {{ $lang.examProvider }}
                </span>
                <cui-select
                    :data="examProviders"
            ...
            <div v-else>
                <div
                    v-for="(examGroup, examGroupIndex) in examinationsGrouped"
                    :key="examGroupIndex"
                >
                    <div>
...
export default {
    ...
    methods: {
        ...
        async getExams() {
            ...
            examinations.forEach((item) => {
                ...
                index > -1
                    ...
                    : grouped.push({ _id: item.class._id, items: [item] });
            });
        ...
        calcBMI() {
            setTimeout(() => {
                if (
                    this.input.height.value > 0 &&
                    this.input.weight.value > 0
                ) {
        ...
        async getData() {
            ...
            this.input.xRay.schema = new File([blob], "fileName.jpg", {
                type: "image/png",
            });
            let data = this.input;
