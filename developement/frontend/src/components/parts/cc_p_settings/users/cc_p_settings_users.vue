    ...
    <div class="main">
        ...
        <cui-card v-if="selectedUser">
            <template #header>
                ...
                <cui-button
                    v-if="!selectedUser.isDirectory"
                    label="Save"
                    primary
                    @click="validate()"
                ></cui-button>
                <cui-button
                    v-if="selectedUser.hasOrca"
                    label="Remove Orca Access"
                    primary
                    @click="editOrca()"
                ></cui-button>
                <cui-button
                    v-else
                    label="Add Orca Access"
                    primary
                    @click="editOrca()"
                ></cui-button>
            </template>
            <div v-if="!selectedUser.isDirectory">
                ...
                <cui-input
                    label="Lastname"
                    v-model="selectedUser.nameLast"
                ></cui-input>
                <cui-input
                    label="Firstname"
                    v-model="selectedUser.nameFirst"
                ></cui-input>
                <cui-checkbox
                    label="Active"
                ...
                <cui-checkbox
                    disabled
                    label="Orca Access"
                    v-model="selectedUser.hasOrca"
                ></cui-checkbox>
            </div>
            <div v-else>This user is synced from backend.</div>
            <cui-checkbox
     ...
     methods: {
        ...
        validate() {
            ...
            if (this.selectedUser.username === "")
                this.errorMessages.push("Username cannot be empty");
            if (this.selectedUser.nameLast === "")
                this.errorMessages.push("Lastname cannot be empty");
            if (this.resetPassword && this.password.pass === "")
                this.errorMessages.push("Password cannot be empty");
            if (this.resetPassword && this.password.conf === "")
                this.errorMessages.push("Password Confirm cannot be empty");
            if (this.resetPassword && this.password.conf !== this.password.pass)
