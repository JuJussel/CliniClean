  ...
  <div class="cc-card-has-header">
    ...
    <div style="height: calc(100% - 64px); display: flex" class="cc-card-content" ref="loadElm">
        <vs-sidebar
            ...
            open
            notLineActive
            style="border-radius: 20px 30px 30px 20px; overflow: hidden; width: 150px"
            >
            <vs-sidebar-item id="basic">
              <template #icon>
                <i class="fas fa-info"></i>
              </template>
              基本
            </vs-sidebar-item>
            <vs-sidebar-item id="insurance">
              <template #icon>
                <i class="fas fa-id-card"></i>
              </template>
              保険
            </vs-sidebar-item>
            <vs-sidebar-item id="files">
              <template #icon>
                <i class="fas fa-copy"></i>
              </template>
              ファイル
            </vs-sidebar-item>
            <vs-sidebar-item id="social">
              <template #icon>
                <i class="fas fa-id-card"></i>
              </template>
              ソーシャル
        ...
        <div style="flex-grow: 1" class="hidden-tab" v-bind:class="{'active-tab': 'basic' === activeTab}">
        ...
        <div style="flex-grow: 1; padding: 30px; display: flex; flex-direction: column" class="hidden-tab" v-bind:class="{'active-tab': 'insurance' === activeTab}">
        ...
        <div style="flex-grow: 1; padding: 30px" class="hidden-tab" v-bind:class="{'active-tab': 'files' === activeTab}">
