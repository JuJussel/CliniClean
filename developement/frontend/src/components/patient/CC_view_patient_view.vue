<template>
    <div>
        <div>
            <div class="cc-card-header cc-shadow" style="border-radius: 15px; margin:10px" v-if="!preview">
            ...
            <div v-else class="cc-card-header cc-shadow" style="border-radius: 15px; margin:10px">
                <h2>患者情報</h2>
            </div>
        </div>
        <div style="height: calc(100% - 84px); display: flex" ref="loadElm">
            <div style="flex-grow: 1" class="hidden-tab" v-bind:class="{'active-tab': 0 == activeTab}">
                <vs-row style="height: 100%; overflow: auto">
            ...
            <div v-if="!preview" style="width: 100%" class="hidden-tab" v-bind:class="{'active-tab': 1 == activeTab}">
                <div class="content-card customHeight" style="height: calc(50% - 40px)">
                    <vs-table striped style="height: 100%" border>
                        <template #notFound>
                ...
                <vs-row style="height: 50%">
                    <vs-col w="6" style="height: 100%">
                        <div class="content-card customHeight" style="height: 100%">
            ...
            <div v-if="!preview" style="flex-grow: 1" class="hidden-tab" v-bind:class="{'active-tab': 2 == activeTab}">
                <div class="content-card" style="margin-bottom: 20px">
                    <vs-table striped style="height: calc(100% - 10px)">
                        <template #notFound>
                            <img style="width: 200px" src="../../assets/img/empty2.jpg"/>
                            <div>
                                <b style="color: gray">登録なし</b>
