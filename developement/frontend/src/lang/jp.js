export default {
    ...
    problemLabels: {
        ...
        fibroids: "筋腫",
        pid: "PID",
        severeMigraine: "重度片頭痛",
        heartDisease: "心臓病",
        thrombosisStroke: "血栓症・脳卒中",
        hepatitis: "肝炎",
        gallBladderCondition: "胆嚢",
        breastDisease: "乳腺症",
        depression: "うつ病",
        infertility: "不妊",
        asthma: "喘息",
        epilepsy: "てんかん",
        contactLenses: "コンタクトレンズ",
        contraceptiveComplication: "避妊合併症",
    },
    procedursOnly: "行為",
    procedure: "行為",
    procedures: "行為・処方",
